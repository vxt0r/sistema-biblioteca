...
<body class="row bg-dark text-white">
    ...
    <main class="row col-10 col-sm-10 gy-5 ms-5">
        
        <section class="col-10 col-sm-2 gy-3 text-center">
            <a href="estante.php">Minha estante</a>
        </section>

        <section class="col-10 col-sm-10 gy-3 text-center">

            <ul class="row">

            <?php foreach($lista_livros as $livro){?>
                <li class="col-10 col-sm-6 mb-5 list-unstyled">
                    <?php echo $livro->titulo ?>(<?php echo $livro->status_livro ?>)<br><br>

                    <img class="img-fluid w-75 h-75" src="imagens/<?php echo $livro->imagem_jpg ?>" alt=""><br><br>
    ...
    <footer class="col-12 mb-3 text-center">
